...
// through the cracks: window.__ghostcordPCLReset()
...
export default definePlugin({
    ...
    async start() {
        ...
        (window as any).__ghostcordPCLReset = () => forceReset("manually triggered via window.__ghostcordPCLReset()");
    ...
    stop() {
        ...
        clearTimeout(autolockTimeout);
        clearTimeout(watchdogTimeout);
        delete (window as any).__ghostcordPCLReset;
