            ...
            for (const acc of rawAccounts) {
                ...
                if (tok.startsWith("dQw4w9WgXcQ:")) {
                    try {
                        ...
                        console.error("[Ghostcord] decyption failed for ", acc.username, e);
                    }
                }
...
export default definePlugin({
    ...
    start() {
        addHeaderBarButton("ghostcord-token-importer", () => <TokenImporterButton />, 10);
    ...
    stop() {
        removeHeaderBarButton("ghostcord-token-importer");
