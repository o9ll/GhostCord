...
import { settings as musicControlsSettings } from "@ghostcordplugins/musicControls/settings";
import { SpotifyStore } from "@ghostcordplugins/musicControls/spotify/SpotifyStore";
...
const cl = classNameFactory("vc-ghostcord-dynamic-island-");
const NOTIFICATION_DURATION = 5000;
const RUNTIME_KEY = Symbol.for("GhostcordDynamicIsland.runtime");
            ...
            {showVolume && (
                <div style={{ padding: "0 4px" }}>
                    <input 
                        ...
                        max={100} 
                        value={sc.volume} 
                        className="vc-ghostcord-dynamic-island-volume-slider"
...
function ParticipantRow({ p, channel, currentUser }: { p: { user: any; member: any }; channel: any; currentUser: any; }) {
    ...
    return (
        <div 
            className="vc-ghostcord-dynamic-island-participant-row"
            onContextMenu={(e) => {
                e.preventDefault();
    ...
    return (
        ...
        >
            ...
            {showCallParticipants && expanded && participants.length > 0 && (
                <div 
                    className="vc-ghostcord-dynamic-island-voice-participants-list"
                    style={{ 
                        display: "flex", 
                        flexDirection: "column", 
                        gap: "6px", 
