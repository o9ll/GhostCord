...
function VoiceSearchModal({ rootProps, channels }: { rootProps: any; channels: VoiceChannel[] | null; }) {
    ...
    async function join(ch: VoiceChannel) {
        ...
        try {
            ...
            // Small delay for visual effect before closing
...
export default definePlugin({
    ...
    start() {
        addHeaderBarButton("ghostcord-voice-channel-search", () => <VCSHeaderButton />, 9);
    },
    stop() {
        removeHeaderBarButton("ghostcord-voice-channel-search");
        scanCache = null;
    },
});
