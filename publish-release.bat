...
:: Usage: publish-release.bat 1.21.9 "Release v1.21.9"
...
if "%VERSION%"=="" (
    ...
    echo Example: publish-release.bat 1.21.9 "Fixed"
    echo Command: .\publish-release.bat 1.21.9 "Ghostcord v1.21.9"
    pause
    exit /b 1
)
